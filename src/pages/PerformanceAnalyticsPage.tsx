...
import { BarChart2, Calendar, Download, Filter, Search, TrendingUp, TrendingDown, Clock, CheckCircle, XCircle, AlertCircle, ChevronDown, ChevronUp, MessageSquare, Link, Database, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          {/* Search and filters (only for agent and conversation tabs) */}
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-grow">
                  ...
                  <input
                    type="text"
                    placeholder={`Search ${activeTab === 'agents' ? 'agents' : 'conversation categories'}...`}
                    value={searchQuery}
          ...
          <div className="p-6">
            ...
            {activeTab === 'conversations' && (
              <div>
                ...
                <div className="bg-white rounded-lg border p-6">
                  <div className="flex justify-between items-center mb-6">
                    <h3 className="text-lg font-medium text-gray-900">Conversation Flow Analysis</h3>
                  </div>
                  <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                    <BarChart2 className="h-12 w-12 text-gray-300" />
                    <span className="ml-2 text-gray-500">Conversation flow visualization</span>
                  </div>
                </div>
              </div>
            )}
