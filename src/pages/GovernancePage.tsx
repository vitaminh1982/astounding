          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <div className="flex items-center bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
                ...
                <select
                  className="w-full py-2 pl-2 pr-8 bg-transparent text-gray-700 dark:text-gray-200 border-none focus:ring-0 text-sm"
                  value={timeRange}
              ...
              <button 
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm sm:text-base disabled:opacity-50"
              >
              ...
              <button 
                className="flex items-center justify-center gap-2 bg-teal-600 dark:bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-700 dark:hover:bg-teal-600 transition-colors text-sm sm:text-base"
              >
