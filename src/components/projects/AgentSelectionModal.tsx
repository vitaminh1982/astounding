      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-600">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Select AI Agents</h2>
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50">
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                  <Users className="w-4 h-4 text-indigo-600 dark:text-teal-400" />
                ...
                {sortedAgents.map((agent) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`
                        relative p-6 border rounded-xl transition-all duration-200 cursor-pointer bg-white dark:bg-gray-700/50
                        ${isSelected 
                          ? 'border-indigo-500 dark:border-teal-500 bg-indigo-50 dark:bg-teal-900/20 ring-2 ring-indigo-200 dark:ring-teal-500/30' 
                          : canSelect
                          ? 'border-gray-200 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-teal-400 hover:shadow-md dark:hover:shadow-gray-800'
                    ...
                    >
                      ...
                      <div className="absolute top-4 right-4">
                        {isSelected ? (
                          <CheckCircle className="w-6 h-6 text-indigo-600 dark:text-teal-400" />
                        ) : (
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div className="text-center">
                            <div className="flex items-center justify-center gap-1 mb-1">
                              ...
                              <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">{agent.rating}</span>
                            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-indigo-600 dark:bg-teal-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-teal-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-sm dark:shadow-gray-900"
                >
                  {isLoading && (
