      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-border dark:border-border">
            <div>
              <h2 className="text-xl font-semibold text-foreground dark:text-foreground">Select AI Agents</h2>
          ...
          <div className="p-6 border-b border-border dark:border-border bg-surface-container-low dark:bg-surface-container-highest/50">
              ...
              <div className="flex items-center gap-4">
                ...
                {tempSelectedIds.length > 0 && (
                  <button
                    ...
                    className="text-sm text-muted-foreground dark:text-muted-foreground hover:text-on-surface dark:hover:text-muted-foreground underline transition-colors"
                  >
                    Clear all
                  </button>
                )}
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {sortedAgents.length === 0 ? (
              <div className="text-center py-12">
                <div className="text-outline dark:text-muted-foreground mb-4">
                  <Bot className="w-12 h-12 mx-auto" />
                </div>
                <h3 className="text-lg font-medium text-foreground dark:text-foreground mb-2">No agents found</h3>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute top-4 left-4 flex gap-1">
                        {agent.isRecommended && (
                          <span className="px-2 py-1 bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300 text-xs rounded-full font-medium">
                            Recommended
                          </span>
                        )}
                        {agent.isPopular && (
                      ...
                      <div className="mt-8 mb-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <h3 className="font-semibold text-foreground dark:text-foreground">{agent.name}</h3>
                            <p className="text-sm text-muted-foreground dark:text-muted-foreground">{agent.role}</p>
                          </div>
                        </div>
                        ...
                        {/* Capabilities */}
                        <div className="mb-4">
                          <h4 className="text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider mb-2">
                            Key Capabilities
                          </h4>
                          <div className="flex flex-wrap gap-1">
                            {agent.capabilities.slice(0, 3).map((capability) => (
                              <span 
                                key={capability} 
                                className="px-2 py-1 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground text-xs rounded-full"
                              >
                                {capability}
                              </span>
                            ))}
                            {agent.capabilities.length > 3 && (
                              <span className="px-2 py-1 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground text-xs rounded-full">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div className="text-center">
                            <div className="flex items-center justify-center gap-1 mb-1">
                              ...
                              <span className="text-sm font-semibold text-foreground dark:text-foreground">{agent.rating}</span>
                            </div>
                            <p className="text-xs text-muted-foreground dark:text-muted-foreground">Rating</p>
                          </div>
                          <div className="text-center">
                            <p className="text-sm font-semibold text-green-600 dark:text-green-400">{agent.successRate}%</p>
