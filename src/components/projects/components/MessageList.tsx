...
const MessageList: React.FC<MessageListProps> = ({
  ...
  const renderEmptyState = () => (
    ...
    >
      <div className="text-center max-w-sm">
        <div className="text-outline dark:text-muted-foreground mb-4 text-6xl" aria-hidden="true">
          💬
        </div>
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-outline dark:text-muted-foreground">
          <kbd className="px-2 py-1 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground rounded border border-border dark:border-border transition-colors">
            Shift + Enter
          </kbd>
  ...
  const renderErrorState = () => (
    ...
    >
      <div className="text-center max-w-sm">
        <div className="text-destructive dark:text-destructive mb-4 text-5xl" aria-hidden="true">
          ⚠️
        </div>
        <h3 className="text-lg font-medium text-foreground dark:text-foreground mb-2">
