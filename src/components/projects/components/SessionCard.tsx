    ...
    switch (status) {
      ...
      default:
        return {
          ...
          bg: 'bg-surface-container-low dark:bg-surface-container-highest',
          border: 'border-border dark:border-border',
          badge: 'bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground',
          label: 'Unknown'
        };
    }
  };
      ...
      <div className="border border-border dark:border-border rounded-lg p-4 hover:shadow-md dark:hover:shadow-gray-900 hover:border-indigo-300 dark:hover:border-teal-400 transition-all duration-200 bg-white dark:bg-surface-container-high">
        <div className="flex justify-between items-start">
          <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                {session.isAutonomous ? (
                  <div className="relative">
                    <Bot className="w-5 h-5 text-tertiary dark:text-tertiary" />
            ...
            <p className="text-sm text-muted-foreground dark:text-muted-foreground mb-3 line-clamp-2">{session.summary}</p>
            <div className="flex items-center gap-4 text-xs text-muted-foreground dark:text-muted-foreground flex-wrap">
          ...
          <div className="flex gap-2 ml-4">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground rounded-lg hover:bg-surface-container dark:hover:bg-surface-container-highest transition-colors text-sm font-medium"
      ...
      <div className="bg-white dark:bg-surface-container-high rounded-xl border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-lg dark:hover:shadow-gray-800 hover:border-indigo-200 dark:hover:border-teal-400 transition-all duration-300 overflow-hidden group">
        ...
        <div className={`bg-gradient-to-br ${getAgentGradient(session.agentName)} p-4 relative overflow-hidden`}>
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white dark:bg-surface-container-high rounded-full -mr-16 -mt-16"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white dark:bg-surface-container-high rounded-full -ml-12 -mb-12"></div>
          </div>
          
          <div className="relative flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white/20 dark:bg-surface-container-high/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-white border-2 border-white/30 dark:border-gray-800/30 shadow-lg group-hover:scale-110 transition-transform">
                {session.isAutonomous ? (
            ...
            <div className="flex flex-col gap-1.5 items-end">
              {session.isAutonomous && (
                <span className="px-2 py-1 bg-white/20 dark:bg-surface-container-high/20 backdrop-blur-sm text-white text-xs font-medium rounded-full flex items-center gap-1 border border-white/30 dark:border-gray-800/30">
                  <Zap className="w-3 h-3" />
                  Auto
                </span>
              )}
              <span className={`px-2 py-1 bg-white/90 dark:bg-surface-container-high/90 backdrop-blur-sm rounded-full text-xs font-medium ${statusConfig.color}`}>
                {statusConfig.label}
              </span>
            </div>
          </div>
        ...
        {/* Card Body */}
        <div className="p-4">
          <p className="text-sm text-on-surface dark:text-muted-foreground mb-4 line-clamp-2 min-h-[2.5rem]">
            {session.summary}
          </p>

          {/* Stats Grid */}
          <div className="grid grid-cols-3 gap-2 mb-4">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg p-2.5 text-center border border-border dark:border-border transition-colors">
              <div className="text-xs text-muted-foreground dark:text-muted-foreground mb-0.5 flex items-center justify-center gap-1">
                <MessageSquare className="w-3 h-3" />
              </div>
              <div className="text-sm font-semibold text-foreground dark:text-foreground">{session.messageCount}</div>
              <div className="text-xs text-muted-foreground dark:text-muted-foreground">msgs</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg p-2.5 text-center border border-border dark:border-border transition-colors">
              <div className="text-xs text-muted-foreground dark:text-muted-foreground mb-0.5 flex items-center justify-center gap-1">
                <Clock className="w-3 h-3" />
              </div>
              <div className="text-sm font-semibold text-foreground dark:text-foreground">{session.duration}</div>
              <div className="text-xs text-muted-foreground dark:text-muted-foreground">time</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg p-2.5 text-center border border-border dark:border-border transition-colors">
              <div className="text-xs text-muted-foreground dark:text-muted-foreground mb-0.5">
                {statusConfig.icon}
              </div>
              <div className="text-xs font-semibold text-foreground dark:text-foreground capitalize">{session.status}</div>
              <div className="text-xs text-muted-foreground dark:text-muted-foreground">status</div>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <button
              onClick={() => onViewSession(session)}
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground rounded-lg hover:bg-surface-container dark:hover:bg-surface-container-highest transition-colors text-sm font-medium"
            >
              <Eye className="w-4 h-4" />
              View
            </button>
      ...
      <div className="bg-white dark:bg-surface-container-high rounded-xl border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-lg dark:hover:shadow-gray-800 transition-all duration-300 overflow-hidden group-hover:border-indigo-200 dark:group-hover:border-teal-400 group-hover:-translate-y-1">
        <div className="p-5">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  <h4 className="font-semibold text-foreground dark:text-foreground text-base">{session.agentName}</h4>
                  {session.isAutonomous && (
            ...
            <button className="p-1.5 hover:bg-surface-container-low dark:hover:bg-surface-container-highest rounded-lg transition-colors opacity-0 group-hover:opacity-100 flex-shrink-0">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => onViewSession(session)}
              className="flex items-center gap-2 px-4 py-2 bg-surface-container-low dark:bg-surface-container-highest text-on-surface dark:text-muted-foreground rounded-lg hover:bg-surface-container dark:hover:bg-surface-container-highest transition-colors text-sm font-medium"
            >
              <Eye className="w-4 h-4" />
              View Details
            </button>
