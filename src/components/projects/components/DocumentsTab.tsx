...
const DocumentsTab: React.FC = () => {
  ...
  if (documents.length === 0) {
    return (
      <div className="p-6 h-full flex items-center justify-center bg-surface-container-low dark:bg-background transition-colors">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 bg-surface-container-low dark:bg-surface-container-highest rounded-xl flex items-center justify-center mx-auto mb-4 transition-colors">
            <FileText className="w-8 h-8 text-outline dark:text-muted-foreground" />
          </div>
          <h3 className="text-lg font-semibold text-foreground dark:text-foreground mb-2">No Documents Yet</h3>
          ...
          <div className="flex justify-center gap-3">
            ...
            <button 
              ...
              className="px-5 py-2.5 border border-border dark:border-border text-on-surface dark:text-muted-foreground rounded-lg hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors flex items-center gap-2 font-medium"
            >
  ...
  return (
    <div className="flex flex-col h-full bg-surface-container-low dark:bg-background transition-colors">
      {/* Simple Header */}
      <div className="bg-white dark:bg-surface-container-high border-b border-border dark:border-border p-6 transition-colors">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-xl font-semibold text-foreground dark:text-foreground mb-1">Project Deliverables</h2>
          ...
          <div className="flex gap-3">
            ...
            <button 
              onClick={handleUpload}
              className="px-4 py-2 border border-border dark:border-border text-on-surface dark:text-muted-foreground rounded-lg hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors flex items-center gap-2 font-medium"
            >
              <Upload className="w-4 h-4" />
              Upload
            </button>
        ...
        {filteredDocuments.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <FolderOpen className="w-12 h-12 text-outline dark:text-muted-foreground mx-auto mb-4" />
              <h3 className="text-lg font-medium text-foreground dark:text-foreground mb-2">No documents found</h3>
