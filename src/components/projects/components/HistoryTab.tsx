      ...
      <div className="bg-white border-b shadow-sm">
        <div className="p-6">
          <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between mb-6">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-1">Chat History</h3>
            ...
            <div className="flex gap-4">
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl px-4 py-3 border border-indigo-200">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-indigo-600">Total Sessions</span>
                </div>
                <div className="text-2xl font-bold text-indigo-900">{stats.totalSessions}</div>
              </div>
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl px-4 py-3 border border-green-200">
                <div className="flex items-center gap-2 mb-1">
                  <TrendingUp className="w-4 h-4 text-green-600" />
                  <span className="text-xs font-medium text-green-600">This Week</span>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            <div className="flex flex-col sm:flex-row gap-3 flex-1">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm w-full bg-white"
                />
              </div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm appearance-none bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 min-w-[150px]"
                >
            ...
            <div className="flex gap-2">
              ...
              {/* Export Button */}
              <button className="p-2.5 border border-gray-200 bg-white rounded-lg hover:bg-gray-50 transition-colors">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {Object.keys(groupedSessions).length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No chat history found</h3>
          ...
          <div className={viewMode === 'grid' ? 'space-y-8' : 'space-y-6'}>
            {Object.entries(groupedSessions).map(([groupKey, sessions]) => (
              <div key={groupKey}>
                {/* Group Header */}
                <div className="sticky top-0 z-10 bg-gradient-to-r from-gray-100 to-transparent backdrop-blur-sm py-3 px-4 rounded-lg mb-4 border-l-4 border-indigo-500">
