      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Switch Project</h2>
              <p className="text-sm text-gray-500 mt-1">Select a consulting project to work on</p>
            </div>
            <button
              onClick={onClose}
                  ...
                  >
                    ...
                    {project.id === currentProjectId && (
                      <div className="absolute top-4 right-4">
                        <div className="flex items-center gap-1 px-2 py-1 bg-indigo-600 text-white text-xs rounded-full">
                    ...
                    <div className="mb-4">
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-lg font-semibold text-gray-900 pr-16">{project.name}</h3>
                      </div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{project.client.industry}</p>
                        </div>
                      </div>
                    </div>
