...
export const nodeTypes = {
  trigger: {
    icon: <Mail className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
    label: 'Email Trigger',
  ...
  agent: {
    icon: <Bot className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
    label: 'AI Agent',
  ...
  action: {
    icon: <Tool className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
    label: 'Action',
  ...
  notification: {
    icon: <Slack className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
    label: 'Notification',
  ...
  database: {
    icon: <Database className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
  ...
  output: {
    icon: <FileOutput className="w-4 h-4 text-green-600 dark:text-green-400 transition-colors" />,
    label: 'Email Output',
