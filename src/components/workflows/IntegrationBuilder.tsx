    ...
    <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors">
        ...
        <button
          ...
          className="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 shadow-sm hover:shadow-md transition-all duration-200 whitespace-nowrap"
