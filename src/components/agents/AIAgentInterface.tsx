...
import { ArrowLeft, Play, Pause, Settings, Telescope as Envelope, Search, Code, Image, BarChart2, Plus, Mic, MicOff, Upload, X, FileText, AlertCircle, CheckCircle } from 'lucide-react'// Import the AgentConfigModal
