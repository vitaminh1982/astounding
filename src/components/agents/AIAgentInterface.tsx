...
Remember that your main goal is customer satisfaction while respecting company procedures and policies.`
  ...
  return (
    <div className="flex flex-col h-screen bg-surface-container-low dark:bg-background transition-colors">
      <AgentHeader
      ...
      <div className="flex flex-1 overflow-hidden">
        <main className="flex-1 flex flex-col p-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-foreground dark:text-foreground">Chat with {agentConfig.name}</h3>
          </div>
