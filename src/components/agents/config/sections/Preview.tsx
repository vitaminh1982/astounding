  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-foreground dark:text-foreground">Chat with {agent?.name || 'Agent'}</h3>
      </div>

      <div className="border border-border dark:border-border bg-white dark:bg-surface-container-highest rounded-lg p-4 space-y-4 transition-colors">
        <div className="space-y-4 h-[350px] overflow-y-auto">
          ...
          {isThinking && (
            <div className="flex items-start gap-3">
              <span className="text-2xl">{agent?.avatar || '👩‍💼'}</span>
              <div className="bg-surface-container-low dark:bg-surface-container-highest rounded-lg p-3 max-w-[70%]">
