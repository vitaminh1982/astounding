...
function MetricTrend({ metric }: MetricProps) {
  return (
    <div className="flex items-center gap-1 text-sm md:text-base text-green-500">
...
function MetricInfo({ metric }: MetricProps) {
  return (
    <div>
      ...
      <div className="text-sm md:text-base text-gray-500">{metric.label}</div>
    </div>
  );
}
...
function MetricCard({ metric }: MetricProps) {
  return (
    <div key={metric.label} className="p-3 md:p-6 rounded-lg border">
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 md:p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-semibold text-lg md:text-xl">Analytics</h2>
