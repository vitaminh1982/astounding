...
const SettingsTab: React.FC<SettingsTabProps> = ({ workspaceData, setWorkspaceData }) => {
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-foreground dark:text-foreground">Workspace Settings</h3>
      
      <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border p-6">
        <form className="space-y-6">
          <div>
            <label htmlFor="workspaceName" className="block text-sm font-medium text-on-surface dark:text-on-surface-variant mb-1">
              Workspace Name
            </label>
            <input
              id="workspaceName"
          ...
          <div>
            <label htmlFor="workspaceDescription" className="block text-sm font-medium text-on-surface dark:text-on-surface-variant mb-1">
              Description
            </label>
            <textarea
          ...
          <div>
            ...
            <div className="flex items-center">
              <div className="h-16 w-16 rounded-lg bg-surface-container-low dark:bg-surface-container-highest flex items-center justify-center mr-4">
                {workspaceData.logo ? (
              ...
              <div>
                <button
                  type="button"
                  className="px-4 py-2 bg-white dark:bg-surface-container-highest border border-border dark:border-border rounded-md shadow-sm text-sm font-medium text-on-surface dark:text-on-surface-variant hover:bg-surface-container-low dark:hover:bg-surface-container-highest focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring dark:focus:ring-ring dark:focus:ring-offset-gray-800 transition-colors"
                >
                  Upload Logo
                </button>
          ...
          <div className="pt-4 border-t border-border dark:border-border">
            <h4 className="text-sm font-medium text-on-surface dark:text-on-surface-variant mb-3">Danger Zone</h4>
            <button
              type="button"
