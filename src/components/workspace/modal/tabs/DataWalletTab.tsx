...
const DataGovernanceOverview = () => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border p-4">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-muted-foreground dark:text-muted-foreground">Data Compliance</p>
      ...
      <p className="text-xs text-muted-foreground dark:text-muted-foreground mt-2">GDPR & SOC2 compliant</p>
    </div>
    ...
    <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border p-4">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-muted-foreground dark:text-muted-foreground">Retention Policy</p>
          <p className="text-2xl font-bold text-tertiary dark:text-tertiary">Active</p>
        </div>
        <Calendar className="w-8 h-8 text-tertiary dark:text-tertiary" />
      </div>
      <p className="text-xs text-muted-foreground dark:text-muted-foreground mt-2">Auto-cleanup enabled</p>
    </div>
  </div>
);
...
const UserDataControls = () => (
  <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border p-4 mb-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <button className="flex flex-col items-center p-3 border border-border dark:border-border rounded-lg hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors">
        ...
        <span className="text-sm font-medium text-foreground dark:text-foreground">Update Info</span>
        <span className="text-xs text-muted-foreground dark:text-muted-foreground text-center">Modify your data</span>
      </button>
      
      <button className="flex flex-col items-center p-3 border border-border dark:border-border rounded-lg hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors">
        <EyeOff className="w-6 h-6 text-tertiary dark:text-tertiary mb-2" />
        <span className="text-sm font-medium text-foreground dark:text-foreground">Privacy Settings</span>
        <span className="text-xs text-muted-foreground dark:text-muted-foreground text-center">Control visibility</span>
      </button>
      
      <button className="flex flex-col items-center p-3 border border-border dark:border-border rounded-lg hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors">
        <Trash2 className="w-6 h-6 text-red-600 dark:text-destructive mb-2" />
        <span className="text-sm font-medium text-foreground dark:text-foreground">Delete Data</span>
        <span className="text-xs text-muted-foreground dark:text-muted-foreground text-center">Remove permanently</span>
      </button>
    </div>
  </div>
);
...
const DataFlowDiagram = () => (
  <div className="bg-surface-container-low dark:bg-surface-container-high rounded-lg p-4 mb-6">
    <h4 className="font-medium text-foreground dark:text-foreground mb-3">How Your Data is Organized</h4>
    <div className="flex items-center justify-between">
      <div className="text-center">
        <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center mx-auto mb-2">
          <User className="w-6 h-6 text-tertiary dark:text-purple-300" />
        </div>
        <p className="text-sm font-medium text-foreground dark:text-foreground">Personal Data</p>
        <p className="text-xs text-muted-foreground dark:text-muted-foreground">Only you control</p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-sm font-medium text-foreground dark:text-foreground">Usage Analytics</p>
        <p className="text-xs text-muted-foreground dark:text-muted-foreground">System generated</p>
      </div>
    </div>
  </div>
);
...
const DataWalletHeader = () => (
  <div className="mb-6">
    <div className="flex justify-between items-start">
      <div>
        <h3 className="text-2xl font-bold text-foreground dark:text-foreground">Secure Data Vault</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border p-4">
        <div className="flex justify-between items-center mb-3">
          <h4 className="font-medium text-foreground dark:text-foreground">Storage Usage</h4>
        ...
        <div className="w-full bg-surface-container dark:bg-surface-container-highest rounded-full h-2">
          <div 
            className="bg-tertiary dark:bg-primary h-2 rounded-full transition-all duration-300"
          ...
          {Object.entries(categories).map(([key, category]) => {
            ...
            return (
              ...
              >
                ...
                <span className="bg-surface-container-low dark:bg-surface-container-highest text-muted-foreground dark:text-muted-foreground px-2 py-0.5 rounded-full text-xs">
      ...
      <div className="bg-surface-container-low dark:bg-surface-container-high rounded-lg p-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-border dark:border-border rounded-lg bg-white dark:bg-surface-container-highest text-foreground dark:text-foreground placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 dark:focus:ring-ring focus:border-transparent"
          />
        </div>
        
        <div className="flex items-center space-x-2">
          <button className="flex items-center space-x-2 px-4 py-2 border border-border dark:border-border rounded-lg bg-white dark:bg-surface-container-highest text-on-surface dark:text-on-surface-variant hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors">
      ...
      <div className="bg-white dark:bg-surface-container-high rounded-lg border border-border dark:border-border overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-surface-container-low dark:bg-surface-container-highest">
              <tr>
                <th 
                  className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider cursor-pointer hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors"
            ...
            <tbody className="bg-white dark:bg-surface-container-high divide-y divide-gray-200 dark:divide-gray-700">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-surface-container-low dark:hover:bg-surface-container-highest transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center space-x-2">
                          <h4 className="text-sm font-medium text-foreground dark:text-foreground">{item.name}</h4>
                          <DataOwnershipBadge owner={item.owner} />
                        </div>
                        <p className="text-sm text-muted-foreground dark:text-muted-foreground mt-1">{item.description}</p>
                        <div className="flex items-center space-x-4 mt-2">
                          <PrivacyLevelIndicator level={item.privacyLevel} />
                          <span className="text-xs text-outline dark:text-muted-foreground">
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      {item.owner === 'user' && (
                        <>
                          ...
                          <button className="text-red-600 dark:text-destructive hover:text-red-900 dark:hover:text-red-300 p-1 rounded hover:bg-red-50 dark:hover:bg-red-900 transition-colors">
        ...
        {filteredData.length === 0 && (
          <div className="py-12 text-center">
            <div className="mx-auto h-12 w-12 text-outline dark:text-muted-foreground">
              <Database className="h-full w-full" />
            </div>
            <h3 className="mt-2 text-sm font-medium text-foreground dark:text-foreground">No data found</h3>
      ...
      {activeCategory === 'personal' && (
        <div className="bg-purple-50 dark:bg-purple-900 border border-purple-100 dark:border-purple-800 rounded-lg p-4 flex items-start">
          <Info className="w-5 h-5 text-tertiary dark:text-purple-300 mt-0.5 flex-shrink-0" />
          <div className="ml-3">
            <h4 className="text-sm font-medium text-purple-800 dark:text-purple-200">Personal Data Protection</h4>
            <p className="mt-1 text-sm text-tertiary dark:text-purple-300">
