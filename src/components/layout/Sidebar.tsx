...
const Sidebar = ({ 
  ...
  const orchestrationSubmenu = [
    { icon: Bot, label: 'Agent Management', page: 'agent-directory' as const },
    { icon: GitBranch, label: 'Workflow & Tasks', page: 'workflow-designer' as const },
    { icon: BarChart2, label: 'Monitoring & Analytics', page: 'activity-dashboard' as const },
    { icon: Server, label: 'Resource Management', page: 'resource-allocation' as const },
    { icon: Share2, label: 'Collaboration', page: 'human-agent-collaboration' as const },
  ];
