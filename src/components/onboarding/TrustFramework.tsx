    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-surface-container-low dark:bg-surface-container-high rounded-xl p-6 border border-border dark:border-border transition-colors">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-indigo-100 dark:bg-teal-900 rounded-lg transition-colors">
              <Shield className="w-5 h-5 text-primary-green dark:text-teal-300" />
            </div>
        ...
        <div className="bg-surface-container-low dark:bg-surface-container-high rounded-xl p-6 border border-border dark:border-border transition-colors">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-indigo-100 dark:bg-teal-900 rounded-lg transition-colors">
              <Lock className="w-5 h-5 text-primary-green dark:text-teal-300" />
            </div>
        ...
        <div className="bg-surface-container-low dark:bg-surface-container-high rounded-xl p-6 border border-border dark:border-border transition-colors">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-indigo-100 dark:bg-teal-900 rounded-lg transition-colors">
              <FileText className="w-5 h-5 text-primary-green dark:text-teal-300" />
            </div>
        ...
        <div className="bg-surface-container-low dark:bg-surface-container-high rounded-xl p-6 border border-border dark:border-border transition-colors">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-indigo-100 dark:bg-teal-900 rounded-lg transition-colors">
              <AlertTriangle className="w-5 h-5 text-primary-green dark:text-teal-300" />
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <div className="p-1 bg-indigo-100 dark:bg-teal-800 rounded-full mt-0.5 mr-2 transition-colors">
                  <div className="w-1.5 h-1.5 bg-primary dark:bg-teal-300 rounded-full"></div>
                </div>
