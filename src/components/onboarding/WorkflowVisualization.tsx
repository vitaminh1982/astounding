...
const CustomNode: React.FC<{
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-3 border-2 border-indigo-200">
      <Handle type="target" position={Position.Top} id={`${id}-target`} style={{ background: '#4F46E5' }} />
      ...
      <Handle type="source" position={Position.Bottom} id={`${id}-source`} style={{ background: '#4F46E5' }} />
    </div>
  );
};
