...
const PlatformOverview: React.FC<PlatformOverviewProps> = ({ onNext }) => {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-on-surface dark:text-foreground mb-4 transition-colors">Platform Overview</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-surface-container-low dark:bg-surface-container-high rounded-xl p-6 border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
          ...
          <p className="text-muted-foreground dark:text-muted-foreground mb-4 transition-colors">
      ...
      <div className="bg-indigo-50 dark:bg-teal-900 rounded-xl p-6 border border-indigo-100 dark:border-teal-800 shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-surface-container-highest p-4 rounded-lg text-center border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
            <div className="text-on-surface dark:text-foreground font-medium transition-colors">CRM Systems</div>
          </div>
          <div className="bg-white dark:bg-surface-container-highest p-4 rounded-lg text-center border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
            <div className="text-on-surface dark:text-foreground font-medium transition-colors">Knowledge Bases</div>
          </div>
          <div className="bg-white dark:bg-surface-container-highest p-4 rounded-lg text-center border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
            <div className="text-on-surface dark:text-foreground font-medium transition-colors">Communication</div>
          </div>
          <div className="bg-white dark:bg-surface-container-highest p-4 rounded-lg text-center border border-border dark:border-border shadow-sm dark:shadow-gray-900 hover:shadow-md dark:hover:shadow-gray-800 transition-all duration-200">
            <div className="text-on-surface dark:text-foreground font-medium transition-colors">Data Warehouses</div>
          </div>
        </div>
      </div>
