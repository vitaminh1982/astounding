            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-medium text-foreground dark:text-foreground">{tip.title}</h4>
                    <p className="text-sm text-muted-foreground dark:text-muted-foreground mt-1">{tip.description}</p>
                  </div>
                </div>
              </div>
